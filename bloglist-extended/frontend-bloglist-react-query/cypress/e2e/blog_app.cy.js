  ...
  describe('when logged in', function () {
    ...
    it('a blog can be created', function () {
      ...
      cy.get('.message')
        .should(
          'contain',
          'A New Blog: a new blog created by cypress by johnny cypress added'
        )
        .and('have.css', 'color', 'rgb(0, 128, 0)')
      cy.get('.blogStyle').should(
        'contain',
        'a new blog created by cypress by johnny cypress'
      )
    })

    it('a blog can be liked', function () {
      cy.createBlog({
        title: 'the second blog in cypress',
        author: 'Jim Cypressing',
        url: 'cypress.com/jjpress'
      })

      cy.contains('the second blog in cypress')
        .parent()
        .contains('view')
        .click()
      cy.contains('the second blog in cypress')
    ...
    it('a blog can be deleted by its user', function () {
      cy.createBlog({
        title: 'the deleted blog in cypress',
        author: 'Jim Cypressing',
        url: 'cypress.com/jjpress'
      })

      cy.contains('the deleted blog in cypress')
        .parent()
        .contains('view')
        .click()
      cy.contains('the deleted blog in cypress')
    ...
    it('a blog can only be deleted by its creator', function () {
      ...
      cy.createBlog({
        title: 'the undeletable blog in cypress',
        author: 'Jim Cypressing',
        url: 'cypress.com/jjpress'
      })
      ...
      cy.contains('the undeletable blog in cypress')
        .parent()
        .contains('view')
        .click()
    ...
    it('blogs are ordered by likes high->low', function () {
      cy.createBlog({
        title: 'The lowest likes',
        author: 'Jim Cypressing',
        url: 'cypress.com/jjpress'
      })
      cy.createBlog({
        title: 'The highest likes',
        author: 'Jim Cypressing',
        url: 'cypress.com/jjpress'
      })
